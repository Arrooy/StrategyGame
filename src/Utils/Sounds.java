...
/** Sounds gestiona els sorolls i la musica del joc*/
public class Sounds extends Thread {

    /** Localitzacio dels sounds a l'interior de la carpeta d'assets*/
    private static final String PATH = "./assets/Sound";
        ...
        if (listOfFiles != null) {
            ...
            for (File soundFile : listOfFiles) {
                try {
                    ...
                    System.out.println("Loaded " + audios.size() + " sound clips.");
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
